...
func (x *GetProductsResponse) Reset() {
	*x = GetProductsResponse{}
	mi := &file_catalog_pb_catalog_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetProductsResponse) Descriptor() ([]byte, []int) {
	return file_catalog_pb_catalog_proto_rawDescGZIP(), []int{6}
}
...
const file_catalog_pb_catalog_proto_rawDesc = "" +
	...
	"\vGetProducts\x12\x16.pb.GetProductsRequest\x1a\x17.pb.GetProductsResponse\"\x00B,Z*github.com/abhinavmedikonda/OMS/catalog/pbb\x06proto3"
...
var file_catalog_pb_catalog_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
